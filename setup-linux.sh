...
#ansible-galaxy remove fubarhouse.nodejs
#ansible-galaxy install fubarhouse.nodejs
ansible-playbook -i "localhost," -c local $HOME/.dotfiles/setup-linux.yml --extra-vars "user_id=$(whoami)"
